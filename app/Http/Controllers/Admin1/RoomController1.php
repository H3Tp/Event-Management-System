...
class RoomController1 extends Controller {
   ...
   public function index()
{
    ...
    if (request()->is('organizer1/*')) {
        return view('organizer1.events.index', compact('rooms'));
    }
    ...
    public function create() {
        $types = EventType::all();
        return view('organizer1.events.create', compact('types'));
    }
    ...
    public function edit(int $id) {
        ...
        $types = EventType::all();
        return view('organizer1.events.edit', compact('room', 'types'));
    }
