...
class RoomTypeController1 extends Controller {
    ...
    public function index() {
        ...
        $types = EventType::all();
        return view('organizer1.eventtypes.index', compact('types'));
    }
    ...
    public function create() {
        return view('organizer1.eventtypes.create');
    }
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('organizer1.eventtypes.index')
    ...
    public function edit(int $id) {
        ...
        return view('organizer1.eventtypes.edit', compact('type'));
    }
