<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h3>All Event
                <a href="<?php echo e(route('admin1.events.create')); ?>" class="btn btn-success rounded-circle">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <?php if($room->orders()->count() == 0): ?>
                                        <form method="post" action="<?php echo e(route('admin1.events.destroy', $room->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <a class="btn btn-warning"
                                        href="<?php echo e(route('admin1.events.edit', $room->id)); ?>">
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Downloads\eventmanagement system_final\eventmanagement system\eventmanagement system\resources\views/admin1/events/index.blade.php ENDPATH**/ ?>