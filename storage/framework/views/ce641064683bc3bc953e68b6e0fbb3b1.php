...
unset($__errorArgs, $__bag); ?>
                            ...
                            <p class="text-center">Already have an account? <a href="<?php echo e(route('login')); ?>">Log In</a></p>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Downloads\eventmanagement system_final\eventmanagement system\eventmanagement system\resources\views/auth/register.blade.php ENDPATH**/ ?>