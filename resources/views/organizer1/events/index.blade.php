...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3>All Event
                <a href="{{ route('organizer1.events.create') }}" class="btn btn-success rounded-circle">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @if($room->orders()->count() == 0)
                                        <form method="post" action="{{ route('organizer1.events.destroy', $room->id) }}">
                                            @csrf
                                            @method('delete')
                                    ...
                                    <a class="btn btn-warning"
                                        href="{{ route('organizer1.events.edit', $room->id) }}">
