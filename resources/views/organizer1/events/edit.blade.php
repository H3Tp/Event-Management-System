...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3" method="post" action="{{ route('organizer1.events.update', ['event' => $room->id]) }}"
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="total_room" value="{{ old('total_room', $room->total_room) }}"
