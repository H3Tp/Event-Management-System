...
@section('content')
    @if($types->isEmpty())
        @include('components.alert-error', ['message' => 'you should create Event Type First!!'])
    @else
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3" method="post" action="{{ route('organizer1.events.store') }}"
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="total_room" value="{{ old('total_room') }}"
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="no_beds" value="{{ old('no_beds') }}"
